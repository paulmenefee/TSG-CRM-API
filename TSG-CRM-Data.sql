INSERT INTO TaskType (TaskTypeId, TaskTypeName) VALUES
    (1, 'User Story'),
    (2, 'Task'),
    (3, 'Bug/Issue');

INSERT INTO TaskStatus (TaskStatusId, TaskStatusName, TaskStatusIsResolved) VALUES
    (1, 'Parked', 0),
    (2, 'In Progress', 0),
...
INSERT INTO Project(ProjectId, ProjectName, ProjectSummary, ProjectDueDate, ProjectIsActive) VALUES
...
INSERT INTO Worker (WorkerId, WorkerFirstName, WorkerLastName, WorkerEmail) VALUES
...
INSERT INTO Task (TaskId, TaskTitle, TaskDetails, TaskDueDate, TaskEstimatedHours, ProjectId, WorkerId, TaskTypeId, TaskStatusId, ParentTaskId) VALUES
